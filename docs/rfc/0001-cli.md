...
* Product string
* Release stage
* Mirrored? (All mandatory repos are mirrored)

```
+------+------------------------------------------------+---------+--------------+--------------------+----------+-----------+
| ID   | Name                                           | Version | Architecture | Product string     | State    | Mirrored? |
+------+------------------------------------------------+---------+--------------+--------------------+----------+-----------+
| 1172 | SUSE Linux Enterprise Software Development Kit | 10      | x86_64       | sles-sdk/10/x86_64 | released | true      |
+------+------------------------------------------------+---------+--------------+--------------------+----------+-----------+
```
